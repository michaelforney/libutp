...
static size_t utp_selective_ack_bytes(UTPSocket *conn, uint base, const uint8_t* mask, uint8_t len, int64_t *min_rtt)
{
...
static void utp_selective_ack(UTPSocket *conn, uint base, const uint8_t *mask, uint8_t len)
{
